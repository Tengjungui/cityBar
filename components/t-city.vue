		...
		<view class="city-search-wrap" v-if="isReach">
			...
			<view class="reach-content" v-show="inputValue">
				<block v-show="searchData.length">
					<view class="li borderBottom" v-for="item in searchData" :key="item.cityId" @click="citySearchList(item)">{{
						item.city
					}}</view>
				</block>
			...
			>
				<view class="block">
					...
					<view class="area borderBottom list-item" id="area">
						...
						<view class="ul" v-if="isToggle">
							<view
								class="li oneEllipsis"
								hover-class="hover"
								:class="{ active: areaName == item.areaName }"
				...
				<view class="city-list">
					<view class="list list-item" v-for="(item, key) of cities" :key="key" :id="key">
						...
						<view
							class="item borderBottom"
							hover-class="hover"
							v-for="innerItem in item"
							:key="innerItem.cityId"
